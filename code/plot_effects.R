...
relative <- bind_rows(
  row3("McClellan et al. 2018",
       ...
       outcome = "Opioid overdose deaths (X40-44, X85, Y10-14; T40.0-T40.4, T40.6; suicides excluded)",
  ...
  row3("Rees et al. 2019",
       ...
       policy = "Naloxone access law",
       outcome = "Opioid-related deaths (any death listing T40.0-T40.4 or T40.6)",
  ...
  row3("Atkins et al. 2019",
       ...
       outcome = "Opioid overdose deaths (X40-44, X60-64, X85, Y10-14; T40.1-T40.4, T40.6)",
  ...
  row3("Abouk et al. 2019‡",
       ...
       outcome = "Opioid overdose deaths (X40-44, X60-64, X85, Y10-14; T40.1-T40.4)",
  ...
  row3("Cataife et al. 2021†",
       ...
       policy = "Naloxone access law",
       outcome = "Opioid-related deaths, age-adjusted (T40.0-T40.4, T40.6)",
  ...
  row3("Doleac & Mukherjee 2022",
       ...
       outcome = "Opioid-related deaths, urban counties (T40.0-T40.4, T40.6)",
  ...
  row3("Sohn et al. 2023§",
       ...
       outcome = "Prescription/treatment-opioid overdose deaths (X40-44, X60-64, X85, Y10-14; T40.2 or T40.3 without T40.0, T40.1, T40.4)",
       derivation = "Table 1 AME -8.61 (-15.13, -2.09) deaths per state-quarter, stated as a 16% reduction from the counterfactual; CI scaled proportionally. NB DID with state and quarter FE, 2006-2020",
  ...
  row3("Dowd 2023 — 2018 giveaway",
       ...
       outcome = "Opioid overdose deaths (X40-44, Y10-14; T40.0-T40.4, T40.6), tract-quarter, Philadelphia and Pittsburgh areas",
  ...
  row3("HEALing Communities 2024¶",
       ...
       outcome = "Opioid overdose deaths, adults (X40-44, X60-64, X85, Y10-14; T40.0-T40.4, T40.6)",
  ...
  row3("Freisthler et al. 2024¶",
       ...
       policy = "Multicomponent cluster RCT",
       outcome = "All-drug overdose deaths, adults (X40-44, X60-64, X85, Y10-14; any substance)",
  ...
  row3("Spackman et al. 2025 — per 10,000 kits",
       ...
       outcome = "Opioid-related deaths (Alberta medical examiner; any opioid in Part 1 cause of death)",
...
absolute <- bind_rows(
  row3("Erfanian et al. 2019 — direct effect",
       ...
       policy = "Naloxone access law",
       outcome = "Opioid overdose deaths per 100k (X40-44, X60-64, X85, Y10-14; T40.0-T40.4, T40.6)",
  ...
  row3("Lee et al. 2021",
       ...
       scaling = "Quarterly × 4",
       policy = "Naloxone access law",
       outcome = "All-drug overdose deaths (X40-44, X60-64, X85, Y10-14; any substance)",
  ...
  row3("Duska et al. 2022",
       ...
       outcome = "Opioid-related deaths (X40-44, X60-64, X85, Y10-14; T40.0-T40.4, T40.6)",
  ...
  row3("Rudolph et al. 2022 — sign reversed",
       ...
       scaling = "Annual estimate",
       policy = "Naloxone access law",
       outcome = "Opioid overdose deaths per 100k aged 12+, 2018 (X40-44, X60-64, X85, Y10-14; T40.0-T40.4, T40.6)",
  ...
  row3("Peet et al. 2024 — NAL adopted 2010–15",
       ...
       outcome = "Non-synthetic opioid deaths, age-adjusted (X40-44, X60-64, X85, Y10-14; T40.1 or T40.2 and not T40.4)",
  ...
  row3("Payne 2026",
       ...
       outcome = "Opioid-related deaths (X40-44, X60-64, X85, Y10-14, Y35.2; T40.0-T40.4, T40.6)",
